...
public class AdminContactLog {
     ...
     * 管理员id
     */
    @Column(name = "administractor_id")
    private Integer administractorId;
     ...
     * 获取管理员id
     *
     * @return administractor_id - 管理员id
     */
    public Integer getAdministractorId() {
        return administractorId;
    }
     ...
     */
    public void setAdministractorId(Integer administractorId) {
        this.administractorId = administractorId;
    }
}