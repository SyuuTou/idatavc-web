...
public class Mht2HtmlUtil {
    public static void main(String[] args){
        Mht2HtmlUtil.mht2html("/Users/zhhu/Documents/蓝海巨浪/数据/mht/美国记者体验“复兴号”高铁：纽约都没有这样的火车_凤凰资讯.mht", "/Users/zhhu/Documents/蓝海巨浪/数据/美国记者体验“复兴号”高铁：纽约都没有这样的火车_凤凰资讯.html");
    }
    ...
    private static String getHtmlText(MimeBodyPart bp, String strEncoding) {
        ...
        try {
            ...
            r = new InputStreamReader(buff, strEncoding == null ? "utf-8": strEncoding);
